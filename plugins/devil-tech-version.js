...
cmd({
  ...
  try {
    ...
    const rawVersionUrl = 'https://raw.githubusercontent.com/prince2133/DEVIL-TECH-MD/main/data/version.json';
    ...
    // GitHub stats
    const githubRepo = 'https://github.com/prince2133/DEVIL-TECH-MD';

    // Check update status
    let updateMessage = `*✅ ʏᴏᴜʀ ᴅᴇᴠɪʟ-ᴛᴇᴄʜ-ᴍᴅ ʙᴏᴛ ɪs ᴜᴘ-ᴛᴏ-ᴅᴀᴛᴇ!*`;
    if (localVersion !== latestVersion) {
      updateMessage = `*😵‍💫 ʏᴏᴜʀ ᴅᴇᴠɪʟ-ᴛᴇᴄʜ-ᴍᴅ ʙᴏᴛ ɪs ᴏᴜᴛᴅᴀᴛᴇᴅ!*
    ...
    await conn.sendMessage(from, {
      ...
      contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
          ...
          newsletterName: '☇ 𝐃𝐄𝐕𝐈𝐋 𝐓𝐄𝐂𝐇 𝐌𝐃 𝐒ʊ̊𝐏𝐏๏፝֟ɼʈ  ⃪🤖͎᪳᪳𝆺𝅥',
          serverMessageId: 143
        }
      }
    }, { quoted: mek });
