...
├❒ *Custom Owner React:* ${isEnabled(config.CUSTOM_OWNER_REACT) ? "Enabled ✅" : "Disabled ❌"}
...
> ${config.DESCRIPTION}`;
        ...
        await conn.sendMessage(
            from,
            {
                image: { url: 'https://i.ibb.co/zhvB3bLg/7535.jpg' }, // Image URL
                caption: envSettings,
                contextInfo: {
