...
const REPO_OWNER = 'prince2133';
const REPO_NAME = 'DEVIL-TECH-MD';
...
async (conn, mek, m, { from, reply }) => {
    try {
        ...
        let pluginList = "📂 *DEVIL-TECH-MD PLUGINS:*\n\n";
...
async (conn, mek, m, { from, reply, args, senderNumber }) => {
    try {
        ...
        if (m.quoted && m.quoted.key.fromMe) {
            ...
            if (/📂 \*DEVIL-TECH-MD PLUGINS:\*/i.test(quotedText)) {
        ...
        const statusMessage = {
            image: { url: `https://i.ibb.co/zhvB3bLg/7535.jpg` }, // Replace with your image URL
